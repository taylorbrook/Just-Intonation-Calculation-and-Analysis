...
- [ ] **GEN-01**: User can generate a Combination Product Set (CPS) from a factor set and choose-k, with Hexany / Dekany / Eikosany presets
...
- [ ] **LIB-01**: User can browse and search named scales from the bundled Scala archive within the Generate surface — delivers parked TEMP-09
